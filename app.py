...
# === Class Labels & Disease Info (Simplified for brevity) ===
cow_class_names = ['healthycows', 'lumpycows']
poultry_class_labels = ['Bumblefoot', 'Fowlpox', 'Healthy', 'Unlabeled', 'coryza', 'crd', 'not_poultry'] 

cow_disease_info = { 
    "healthycows": {"description": "The cow appears healthy.", "treatment": "Continue care."},
    "lumpycows": {"description": "Lumpy Skin Disease detected.", "treatment": "Isolate and consult a veterinarian immediately."}
}
poultry_disease_info = { 
    "Healthy": {"description": "The bird appears healthy.", "treatment": "Continue proper hygiene."},
    "coryza": {"description": "Infectious Coryza detected.", "treatment": "Treat with antibiotics."},
    "crd": {"description": "Chronic Respiratory Disease detected.", "treatment": "Administer Tylosin."},
    "Fowlpox": {"description": "Fowlpox detected.", "treatment": "Vaccinate healthy birds."},
    "Bumblefoot": {"description": "Bumblefoot bacterial infection.", "treatment": "Clean and consult a vet."}
}
